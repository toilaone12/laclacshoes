...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<h5>: &#160;<?php echo $row2['DiaChiNN'] ?></h5>
					</div>
					<div class="col-md-3"></div>
					<div class="col-md-3">
						<h5>SĐT Người Nhận </h5>
					</div>
					<div class="col-md-6">
						<h5>: &#160;<?php echo $row2['SDTNN'] ?></h5>
					</div>
				</div>
				<br>
				<hr>
				...
				<hr>
				<h5 class="m-auto">Tổng tiền: <?php echo number_format($so) . ' đ'; ?></h5>
				<br>
				<hr>
		...
		<div class="col-12">
			<center>
				<button type="sub" name="dk" value="đã duyệt" class="btn btn-primary">In hóa Đơn</button>
			</center>
		</div>
