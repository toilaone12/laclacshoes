        ...
        <div class="card">
            ...
            <div class="row justify-content-between">
                <div class="col-6 ml-4">
                    ...
                    <div>
                        <span class="fs-14">Phương thức thanh toán:
                            <?php echo $phuongthuc == 1 ? 'Thanh toán khi nhận hàng' : ($phuongthuc == 2 ? 'Thanh toán bằng MoMo' : 'Thanh toán bằng VNPAY'); ?>
                        </span>
                    </div>
                </div>
                <div class="col-lg-5">
                    ...
                    <div>
                        <span class="fs-14">Địa chỉ: Số 6 Nguyễn Công Hoan, Ngọc Khánh, Ba Đình, Hà Nội</span>
                    </div>
                </div>
            </div>
            <br>
                ...
                <div class="card">
                    <div class="card-body" id="form-invoice">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo number_format($rowPrint['DonGia']) . ' đ'; ?>
                                    </td>
                                    <td class="text-center"><?php echo number_format($rowPrint['ThanhTien']) . ' đ'; ?>
                                    </td>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <ul class="list-unstyled float-start">
                                    <li><span class="mr-1 float-start">Tổng
                                            tiền:</span><?php echo number_format($so) . ' đ'; ?></li>
                                </ul>
                            </div>
                        </div>
