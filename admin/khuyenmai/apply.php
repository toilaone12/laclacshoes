...
<div class="container-fluid">
	<div class=" alert alert-primary">
		<h4 class="page-title">
			...
			</span> ADMIN - LẠC LẠC SHOES &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Khuyến mãi&#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Apply &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; <?php echo $kq['TenKM'] ?>
		</h4>
	</div>
</div>
		...
		<div class="card card-body">
			<div class="row">
				<div class="col-lg-9 col-md-9">
					<table class="table-hover table-striped table text-center">
						<thead>
							<tr class="badge-info">
								<th>Chọn</th>
								<th>Hình nền</th>
