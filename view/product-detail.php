                    ...
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img">
                                <img src="webroot/image/sanpham/<?php echo $product['AnhNen'] ?>" class="img-fluid image-detail-product" alt="Dinh Tri code ">
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img" style="height: 490px;">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh1'] ?>" class="img-fluid <?=$product_detail_image['Anh1'] == "spinner.gif" ? 'image-loading' : 'image-detail-product'?>" alt="Dinh Tri code ">
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img" style="height: 490px;">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh2'] ?>" class="img-fluid <?=$product_detail_image['Anh1'] == "spinner.gif" ? 'image-loading' : 'image-detail-product'?>" alt="Dinh Tri code ">
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img" style="height: 490px;">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh3'] ?>" class="img-fluid <?=$product_detail_image['Anh1'] == "spinner.gif" ? 'image-loading' : 'image-detail-product'?>" alt="Dinh Tri code ">
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img" style="height: 490px;">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh4'] ?>" class="img-fluid <?=$product_detail_image['Anh1'] == "spinner.gif" ? 'image-loading' : 'image-detail-product'?>" alt="Dinh Tri code ">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="block-26 mb-2">
                        ...
                        <?php $count = 0; while ($row = (mysqli_fetch_array($product_detail_size))) { $count++;?>
                            <div class="box-size mt-2">
                                <input type="radio" class="custom-control-input" id="<?php echo $row['MaSize']; ?>" name="size" value="<?php echo $row['MaSize']; ?>" <?=$count==1 ? '' : ''?>>
                                <label class="custom-control-label cursor-pointer <?= $count != 1 ? 'ml-4' : '' ?>" for="<?php echo $row['MaSize']; ?>">
                    ...
                    <div class="block-26 mb-5">
                        ...
                        <?php $count1 = 0; while ($row = (mysqli_fetch_array($product_detail_color))) { $count1++;?>
                            <div class="box-mau mt-2">
                                <input type="radio" class="custom-control-input" id="<?php echo $row['MaMau']; ?>" name="mau" value="<?php echo $row['MaMau']; ?>" <?=$count1==1 ? '' : ''?>>
                                <label class="custom-control-label <?= $count1 != 1 ? 'ml-4' : '' ?>" for="<?php echo $row['MaMau']; ?>">
